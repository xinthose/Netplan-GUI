...
- in `network` component, add a Mac Address field for each interface; use more generic `eth0` and `eth1` instead of hardware specific names like `enp3s0` and `enp4s0`
